...
<body class="bgcolor">
	<form method="post" action="">
		<div class="container login">
			<div class="insert">
				<div class="login_id">
					<h4>E-mail</h4>
					<input type="text" name="username" placeholder="이메일을 기재하세요">
				</div>
				<br>
				<div class="login_id">
					<h4>Name</h4>
					...
					<!-- <table
						...
						<tr>
							<td class="col2"><select name="birth"
								...
								style="width: 20%; height: 50px; margin-left: 10px">
				...
				<div class="create">
					...
					<input class="but3" type="button" value="회원찾기"
						onclick="idpw_search()"> <input class="but4" type="button"
	...
	<script>
		function idpw_search() {
			...
			if (frm.birth.value.length != 6) {
				alert("생년월일을 정확히 입력해주세요");
				return;
			}

			if (frm.contact.value.length > 12) {
				alert("연락처를 정확히 기재해주세요");
				return;
			}

			frm.method = "post";
			frm.action = "findIdpw.jsp"; //넘어간화면
			frm.submit();
		}
	</script>
